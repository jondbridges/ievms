...
**NOTE** Use [ievms version 0.2.1](https://github.com/jondbridges/ievms/raw/v0.2.1/ievms.sh) for VirtualBox < 5.0.
...
To specify where the VMs are installed, use the `INSTALL_PATH` variable:
    ...
    curl -s https://raw.githubusercontent.com/jondbridges/ievms/master/ievms.sh | env INSTALL_PATH="/Path/to/.ievms" bash
...
environment variable. For example, you can set a download speed limit:
    ...
    curl -s https://raw.githubusercontent.com/jondbridges/ievms/master/ievms.sh | env CURL_OPTS="--limit-rate 50k" bash
...
environment variable `REUSE_XP` to anything other than `yes`:
    ...
    curl -s https://raw.githubusercontent.com/jondbridges/ievms/master/ievms.sh | env REUSE_XP="no" bash
...
variable `REUSE_WIN7` to anything other than `yes`:
    ...
    curl -s https://raw.githubusercontent.com/jondbridges/ievms/master/ievms.sh | REUSE_WIN7="no" bash
